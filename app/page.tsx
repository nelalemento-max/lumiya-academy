...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="lumi-experiences" aria-labelledby="lumi-experiences-title">
        <div className="section-heading experiences-heading">
          <span className="section-kicker">
            {lang === "es" ? "EXPERIENCIAS LUMI" : "LUMI EXPERIENCES"}
          </span>
          <h2 id="lumi-experiences-title">
            {lang === "es"
              ? "Aprender también sucede fuera del aula"
              : "Learning also happens beyond the classroom"}
          </h2>
          <p>
            {lang === "es"
              ? "Momentos reales de curiosidad, compañía y aprendizaje con Lumi Academy."
              : "Real moments of curiosity, companionship and learning with Lumi Academy."}
          </p>
        </div>

        <div className="experience-gallery">
          <figure className="experience-card experience-card-tall">
            <img
              src="/experiences/lumi-experience-tablet-01.jpg"
              alt={
                lang === "es"
                  ? "Estudiante concentrado mientras aprende con Lumi Academy en una tableta"
                  : "Student focused while learning with Lumi Academy on a tablet"
              }
              loading="lazy"
            />
            <figcaption>
          ...
          <figure className="experience-card experience-card-wide">
            <img
              src="/experiences/lumi-experience-together.jpg"
              alt={
                lang === "es"
                  ? "Dos estudiantes compartiendo una experiencia de aprendizaje con Lumi Academy"
                  : "Two students sharing a learning experience with Lumi Academy"
              }
              loading="lazy"
            />
            <figcaption>
          ...
          <figure className="experience-card experience-card-tall">
            <img
              src="/experiences/lumi-experience-tablet-02.jpg"
              alt={
                lang === "es"
                  ? "Estudiante observando atentamente una actividad educativa en su tableta"
                  : "Student carefully watching an educational activity on a tablet"
              }
              loading="lazy"
            />
            <figcaption>
              ...
              <strong>
                {lang === "es"
                  ? "Concentración en cada desafío"
                  : "Focused on every challenge"}
              </strong>
            </figcaption>
          </figure>
        </div>
